  ...
  return (
    <div>
      ...
      <div className="header">
        <h1>Faites vos Dons. Chaque geste est d'une valeur inimaginable.</h1>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' , marginTop: '10px', marginRight: '20px' }}>
          <button 
      ...
      <div className="card">
        <div className="card-header">
          <h2 className="card-title">Évolution des dons</h2>
        </div>
      ...
      <div className="card">
              <div className="card-header">
                <h2 className="card-title">Liste des dons ({filteredDons.length})</h2>
              ...
              {loading ? (
                ...
                <div style={{ padding: '40px', textAlign: 'center', color: '#666' }}>
                  ...
                  >
                    <FiPlus /> Ajouter votre premier don
                  </button>
                </div>
              ) : (
