...
const BenevolePage = () => {
  ...
  return (
    <div>
     <h1 style={{ marginTop: '30px', alignContent: 'center',marginLeft: '30px',}}>Ensemble nous transformons le Monde.</h1> 
      <div className="header" style={{ marginTop: '5px' }}>
        
        <div style={{ display: 'flex', gap: '40px',marginLeft:'30px', alignItems: 'center', marginRight: '80px' }}>
          <button
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-info">
            ...
            <p>Total Bénévoles dont  {stats.benevolesActifs} actifs</p>
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            ...
            <p><small style={{ color: '#666', fontSize: '1rem' }}>
              {Math.round((stats.benevolesReguliers / stats.totalBenevoles) * 100) || 0}%
            </small> de Bénévoles Actifs et Réguliers
            </p>
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            ...
            <p>Total Membres dont {stats.membresActifs} cotisations payées</p>
            {/* <small style={{ color: '#666', fontSize: '1rem' }}>
