    ...
    <div className="library-tab">
      <div className="library-header">
        ...
        <div className="library-controls">
          ...
          <button className="refresh-btn" onClick={fetchMediaLibrary} title="Actualiser">
            <FiFilter />
          </button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
          <div className="media-count">
            <span>{filteredMedia.length} média{filteredMedia.length > 1 ? 's' : ''}</span>
          </div>
