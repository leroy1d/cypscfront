    ...
    <header>
      <div className="header-container">
        ...
        <nav className={isMenuOpen ? "active" : ""}>
          <ul>
            <li><Link to="/home" onClick={handleNavClick}>Accueil</Link></li>
            <li><Link to="#missions" onClick={handleNavClick}>Nos Missions</Link></li>
            <li><Link to="#actions" onClick={handleNavClick}>Nos Actions</Link></li>
            <li><Link to="#transparence" onClick={handleNavClick}>Transparence</Link></li>
